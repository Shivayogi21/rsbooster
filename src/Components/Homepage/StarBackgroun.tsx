    ...
    <section className="relative w-full h-[80vh] text-white overflow-hidden">
      ...
      <div className="container relative z-20 flex flex-col items-center justify-center h-full">
        <div className="text-center">
          <h1 className="text-9xl md:text-18xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-blue-600 shadow-2xl">
            R S B
          </h1>
          ...
          <h4 className="text-lg mb-5 md:px-32 text-gray-200 shadow-md">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, officiis. Dicta provident fuga eum ducimus consectetur nihil, fugit reprehenderit 
          </h4>
