...
const Newsletter: React.FC = () => {
  return (
    <>
      ...
      <h3 className="text-white text-4xl font-bold m-5 p-5">Subscribe to Our Newsletter</h3>
        <div className="grid lg:grid-cols-2 items-center gap-16 max-w-7xl mx-auto min-h-[350px] p-6 bg-gradient-to-r from-black-800 to-black-900 rounded-lg">
          <div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <svg
                ...
                className="fill-blue-600 w-12 mb-6 inline-block border border-gray-500 p-3 rounded-md"
                viewBox="0 0 32 32"
              >
            ...
            <div>
              ...
              >
                <g fill="none" className="stroke-blue-600" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="40">
